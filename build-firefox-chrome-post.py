#!/usr/bin/env python3
"""Baut den Beitrag zur Einrichtung in Firefox und Chrome in neun Sprachen.

Gleiches Muster wie build-studierende-post.py: alle Sprachen in derselben Datei,
jede in einem Block mit data-lang, sichtbar ist genau eine — die Wahl trifft
docs/site-lang.js und gilt domainweit. Warum eine Datei statt neun: die Adresse
bleibt dieselbe, ein geteilter Link oeffnet beim Empfaenger in *dessen* Sprache,
und es entsteht kein hreflang-Geflecht aus neun URLs je Beitrag.

Kopf und Fuss stammen aus einer bestehenden Seite, damit Navigation und Stil
nicht auseinanderlaufen.

    python3 build-firefox-chrome-post.py
"""
import json
import re
from pathlib import Path

import texte_artikel_firefox_chrome as T
...
FUSS = """<footer>
      Published 15 August 2026. Every figure carries the date it was taken and links
