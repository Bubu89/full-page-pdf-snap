...
_Quelle: change-stream, 16 Events, generiert 2026-08-06T09:00_
...
<!-- change-stream:auto-block:2026-08-05:END -->
<!-- change-stream:auto-block:2026-08-04:START -->
### 2026-08-04 — Auto-Aggregat (change-stream)

_Quelle: change-stream, 32 Events, generiert 2026-08-06T08:51_
...
**Beruehrte Dateien:**
- `tools/erweiterung-fernsteuern.py` (14x)
- `worker/mcp.js` (13x)
- `docs/index.html` (5x)
- `tools/cloudflare-audit.py` (5x)
- `build-bibliography-post.py` (5x)
- `docs/tools/full-page-pdf-snap/index.html` (4x)
- `docs/notes/mcp-server-what-it-solves/index.html` (4x)
- `tools/links-pruefen.py` (4x)
- `build-einstiegsseiten.py` (4x)
- `tools/cache-nach-deploy.py` (4x)
- `build-headless-install-post.py` (4x)
- `build-llms-index.py` (4x)
- `content.js` (3x)
- `messung-literaturverzeichnis.py` (3x)
- `build-sitemap.py` (3x)
- `build-agent-extension-post.py` (3x)
- `.github/workflows/pruefen-und-ausliefern.yml` (3x)
- `tools/crawler-bericht.py` (3x)
- `popup.html` (2x)
- `make-store-screenshots.py` (2x)
